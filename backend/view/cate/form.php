...
if(isset($_GET['id'])){
   ...
   $detailCateType = $model->getDetailCateType($cate_type_id);   
    $link.="&cate_type_id=".$data['cate_type_id'];
}
?>
<div class="row">
    <div class="col-md-12">
        ...
        <button class="btn btn-primary btn-sm" onclick="location.href='index.php?mod=cate&act=list&cate_type_id=<?php echo $cate_type_id; ?>'">
            Back
        </button>
        ...
        <div class="col-md-6">
            ...
            <div class="box-header">
                ...
                <input type="hidden" value="<?php echo $id; ?>" name="cate_id" id="cate_id" />
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12" >
                            <div class="form-group">
                                <label>Tên danh mục cấp 2 <span class="required"> ( * ) </span></label>
        ...
        <div class="col-md-12 nav-tabs-custom">
            ...
            <div class="button">
                ...
                <button class="btn btn-primary" type="button" onclick="location.href='index.php?mod=cate&act=list&cate_type_id=<?php echo $cate_type_id; ?>'">Cancel</button>
            </div>
