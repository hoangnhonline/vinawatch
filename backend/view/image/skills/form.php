...
if(isset($_GET['id'])){
    ...
    $data = $model->getDetailsSkills($id);     
}
?>
...
<div class="col-md-12">
    <button class="btn btn-primary btn-sm" onclick="location.href='<?php echo $link; ?>'">List skills</button>
        <form method="post" action="controller/Skills.php">            
        ...
        <div class="box box-primary">    
         <div class="box-header">
                ...
                <h3 class="box-title"><?php echo (isset($id) && $id> 0) ? "Cập nhật" : "Tạo mới" ?> skills <?php echo (isset($id) && $id> 0) ? " : ".$data['article_title'] : ""; ?></h3>
        ...
        <div class="box-body">   
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                        ...
                        <label>Ten <img src="img/vi.png" ><span class="required"> ( * ) </span></label>
                ...
                <div class="form-group">
                        ...
                        <input type="text" name="point" class="form-control required" value="<?php echo isset($data['point'])  ? $data['point'] : "" ?>">
