                  ...
                  <div class="panel-body">
                       <div class="col-md-12" >
                          <table class="table table-bordered tbl_value">
                            ...
                            <tr>
                              <td width="200px">Trạng thái đơn hàng</td>
                              <td class="value">
                                <select name="status" class="form-control" id="status">                                    
                                    <option value="2" <?php echo ($arrDetail['status']==2) ? "selected" : ""; ?>>Mới</option>
                                    <option value="1" <?php echo ($arrDetail['status']==1) ? "selected" : ""; ?>>Đang xử lý</option>                                                            
                                    <option value="4" <?php echo ($arrDetail['status']==4) ? "selected" : ""; ?>>Hoàn thành</option>
...
<tr>
                              <td>Mã giảm giá</td>
                              <td class="value">
                                <input type="text" class="form-control" value="<?php if($arrDetail['code_id'] > 0) echo $model->getCodeByID($arrDetail['code_id']) ;?>" name="code_id" id="code_id" readonly='readonly'/>
                              </td>
                            </tr>
 			     <tr>
                              <td>Số tiền giảm</td>
                              <td class="value">
                                <input type="text" class="form-control" value="<?php echo number_format($arrDetail['sale']) ;?>" name="sale" id="sale"/>
                              </td>
                            </tr>
                  ...
                  <div class="panel-body">
                    <table class="table table-bordered table-striped">
                        <tbody><tr>
                            ...
                            <th style="text-align:right;width:1%">Xóa</th>                                                                                                          
                        </tr>
                        <?php                    
                        $k = 0;                    
                       while($row = mysql_fetch_assoc($rs)){                        
                        ...
                        <tr>
                            ...
                            <td>
                              <img src="../<?php echo $model->getImageById($row['product_id']); ?>" width="80" /></td>                                                  
                            <td align="right">
                              <select id="amount_<?php echo $row['id']; ?>"  class="amount">
                                <?php for($i=1; $i<=100;$i++){ ?>
                                <option data-id="<?php echo $row['id']; ?>" data-order='<?php echo $row['order_id']; ?>' value="<?php echo $i; ?>"
                                  <?php if($i == $row['amount']) echo "selected"; ?>
                                  ><?php echo $i; ?></option>
                                <?php } ?>
                              </select>                                                        
                            ...
                            <td align="right" id="total_<?php echo $row['id']; ?>"><?php echo number_format($row['total']); ?></td>
                            <td>
                              <a class="deleteSP" title="Xóa" href="javascript:void(0)" data-id="<?php echo $row['id']; ?>" data-order='<?php echo $row['order_id']; ?>'>
                                Xóa
                              </a>
                            </td>
                        </tr>      
            ...
            <div class="button">
                ...
                <button class="btn btn-danger" onclick="location.href='index.php?mod=order&amp;act=list<?php echo $link_form; ?>'" type="button">Cancel</button>
...
<script type="text/javascript">
    $(function(){
        $('select.amount').change(function(){          
          ...
          var order_id = $(this).find('option:selected').attr('data-order');          
