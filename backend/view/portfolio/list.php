...
$arrTotal = $model->getListPortfolio($cate_id,-1, -1);
...
$arrList = $model->getListPortfolio($cate_id,$offset, $limit);
...
<div class="row">
    ...
    <button class="btn btn-primary btn-sm right" onclick="location.href='index.php?mod=portfolio&act=form'">Add new</button>        
        ...
        <div class="box">
            ...
            <div class="box_search">
                ...
                <form method="get" id="form_search" name="form_search">
                    ...
                    <input type="hidden" name="mod" value="portfolio" />
                    ...
                    <option value="-1">Tất cả</option>
                     <?php foreach ($arrListCate as $cate){ ?>
                        <option value="<?php echo $cate['id']; ?>" <?php echo $cate_id==$cate['id'] ? "selected" : ""; ?>><?php echo $cate['cate_name']; ?></option>
                        <?php } ?>   
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="index.php?mod=portfolio&act=form&id=<?php echo $row['id']; ?>">

                                <?php echo $row['portfolio_name_vi']; ?> 
                        ...
                        <td style="white-space:nowrap">                            
                            ...
                            <a href="javascript:;" alias="<?php echo $row['article_title']; ?>" id="<?php echo $row['id']; ?>" mod="portfolio" class="link_delete" >    
