...
$link = "index.php?mod=tin-dung&act=list";
$data = array();
if(isset($_GET['id'])){
...
<div class="row">
    <div class="col-md-12">
        <button class="btn btn-primary btn-sm" onclick="location.href='index.php?mod=tin-dung&act=list'">Back</button>
        ...
        <div class="col-md-9">
            ...
            <div class="box-header">
                ...
                <h3 class="box-title"><?php echo (isset($id) && $id> 0) ? "Cập nhật" : "Tạo mới" ?> tin dùng <?php echo (isset($id) && $id> 0) ? " : ".$data['name_event'] : ""; ?></h3>
